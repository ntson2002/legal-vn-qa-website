...
class PairModel {
    ...
    public static function insert($r) {
        ...
        $query = "INSERT INTO Pair (question, answer, source_title, add_by, score, date_added, comment, status, other) VALUES "
    ...
    public static function list_all() {
        require_once("config/dbconnect.php");
        $mysqli->query("SET NAMES utf8");
        $query = "SELECT * FROM Pair ORDER BY date_added DESC";
